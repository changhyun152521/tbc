...
export function TrendingUpIcon({ size = 24, className, stroke }: { size?: number; className?: string; stroke?: string }) {
  return (
    <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="none" stroke={stroke ?? 'currentColor'} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function TrendingDownIcon({ size = 24, className, stroke }: { size?: number; className?: string; stroke?: string }) {
  return (
    <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="none" stroke={stroke ?? 'currentColor'} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
