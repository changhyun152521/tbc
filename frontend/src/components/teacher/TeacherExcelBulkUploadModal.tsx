...
import TeacherExcelPreviewTable, { type TeacherPreviewRow } from './TeacherExcelPreviewTable';
...
interface TeacherExcelBulkUploadModalProps {
  open: boolean;
  onClose: () => void;
  onComplete: () => void;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50" onClick={handleClose}>
      ...
      >
        ...
        <div className="p-6 overflow-auto flex-1">
          ...
          {step === 2 && (
            <>
              <TeacherExcelPreviewTable rows={previewRows} />
